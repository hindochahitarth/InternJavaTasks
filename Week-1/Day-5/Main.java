 record CarRecord(int carId,String brand,String model,double price){
 ...
 public Custs(int custId,String custName){
 if(custId<=0){
 ...
 class Main {
     public static void main(String[] args) {
         ...
         Rents carrent = new Rents("Mahindra");

         Car car1 = new Car(1, "Toyota", "Innova", 700000.0d);
         carrent.addCar(car1);

         Custs cust1 = new Custs(1, "ABC");
